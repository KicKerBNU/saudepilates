    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        ...
        <p class="mt-4 text-lg text-gray-600">
          Comece sua jornada fitness hoje com nossa assinatura acessível
        </p>
      </div>

      <div class="mt-16 flex justify-center">
        <div class="relative w-full max-w-md">
          <div class="rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <div class="px-6 pt-6 pb-8 bg-gray-50 sm:p-10 sm:pt-6">
              <ul class="space-y-4">
                <li class="flex items-start">
                  ...
                  <p class="ml-3 text-base text-gray-700">Acompanhamento de progresso</p>
                </li>
                <li class="flex items-start">
                  <div class="flex-shrink-0">
                    <svg class="h-6 w-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p class="ml-3 text-base text-gray-700">Integração com agenda</p>
                </li>
                <li class="flex items-start">
                  <div class="flex-shrink-0">
                    <svg class="h-6 w-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p class="ml-3 text-base text-gray-700">Comunicação com instrutor</p>
                </li>
              </ul>
