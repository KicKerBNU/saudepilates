    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <!-- Anamnesis Card (beside Messages) -->
          <router-link to="/professor/anamnesis" class="bg-white overflow-hidden shadow rounded-lg flex flex-col hover:bg-gray-50" style="height: 100%;">
            <div class="px-4 py-5 sm:p-6 flex-grow flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">{{ $t('anamnesis.quickActionDesc') }}</p>
              </div>
            </div>
            <div class="bg-gray-50 px-4 py-4 sm:px-6 mt-auto">
              <div class="text-sm">
                <span class="font-medium text-indigo-600 hover:text-indigo-500">{{ $t('anamnesis.title') }} <span aria-hidden="true">&rarr;</span></span>
              </div>
            </div>
          </router-link>
        </div>
