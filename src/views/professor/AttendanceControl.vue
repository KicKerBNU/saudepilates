        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
          <div class="px-6 py-6 sm:p-8">
            ...
            <div class="mt-6">
              ...
              <!-- Attendance Tab -->
              <div v-if="activeTab === 'attendance'" class="p-2">
                <div class="max-w-full bg-white rounded-xl shadow-md overflow-hidden">
                  <!-- Form Header -->
                  <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-2">
                  ...
                  <div class="p-3 space-y-3 bg-white">
                      ...
                      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <div class="relative">
                          ...
                          <input 
                            ...
                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg p-2 bg-white"
                          />
                        </div>
                        <div class="relative">
                          <div class="mb-1 flex items-center">
                            ...
                            <label class="block text-xs font-medium text-gray-700">Filtrar por nome</label>
                          </div>
                          <input
                            type="text"
                            v-model="searchQuery"
                    ...
                    <div v-if="isLoading" class="flex justify-center p-4 bg-white rounded-lg shadow-sm">
                      <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-500"></div>
                    </div>
                    
                    <div v-else-if="scheduledClasses.length === 0" class="py-6 px-4 text-center bg-white rounded-lg shadow-sm">
                      ...
                      <button
                        @click="activeTab = 'schedule'"
                        class="mt-3 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                          <thead class="bg-gradient-to-r from-gray-50 to-indigo-50">
                            <tr>
                              ...
                              <th scope="col" class="relative px-4 py-2 text-xs font-medium text-gray-600 uppercase">
                          ...
                          <tbody class="bg-white divide-y divide-gray-100">
                            <tr v-for="(classItem, index) in filteredClasses" :key="classItem.id" class="hover:bg-indigo-50/30 transition-colors">
                              ...
                              <td class="px-4 py-3 whitespace-nowrap">
                                <div class="text-sm text-gray-900 font-medium">{{ formatTime(classItem.startTime) }}</div>
                              </td>
                              <td class="px-4 py-3 whitespace-nowrap">
                                  ...
                                  <button
                                    ...
                                    :class="[
                                      classItem.present === true
                                        ? 'bg-green-100 text-green-800 border-green-300 hover:bg-green-200 ring-2 ring-green-500 ring-opacity-50'
                                        : 'bg-gray-100 text-gray-600 border-gray-300 hover:bg-gray-200',
                                      'inline-flex items-center px-2 py-1 border text-xs font-medium rounded-full transition-all duration-150'
                                    ]"
                                  >
                                    <svg v-if="classItem.present === true" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  ...
                                  <button
                                    ...
                                    :class="[
                                      classItem.present === false
                                        ? 'bg-red-100 text-red-800 border-red-300 hover:bg-red-200 ring-2 ring-red-500 ring-opacity-50'
                                        : 'bg-gray-100 text-gray-600 border-gray-300 hover:bg-gray-200',
                                      'inline-flex items-center px-2 py-1 border text-xs font-medium rounded-full transition-all duration-150'
                                    ]"
                                  >
                                    <svg v-if="classItem.present === false" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                    Ausente
                                  </button>
